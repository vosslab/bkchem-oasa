...
delete_find_matches pythonBuild -type d -name build -prune
delete_find_matches eggInfo -type d -name '*.egg-info' -prune
delete_find_matches distInfo -type d -name '*.dist-info' -prune
delete_path .venv
delete_path venv
delete_path env

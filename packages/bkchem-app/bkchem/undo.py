      ...
      if changed:
        ...
        if o.object_type == 'atom':
          ...
          for e in neigh_edges:
            # collect edges adjacent to both atoms of each neighboring bond
            for a_of_e in e.get_atoms():
              neigh_edges2 |= set([e2 for e2 in a_of_e.neighbor_edges if e2 not in added])

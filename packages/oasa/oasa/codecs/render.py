...
#============================================
def svg_mol_to_file(mol: object, file_obj: object, **kwargs: object) -> None:
	"""Render one molecule to SVG."""
	render_out.render_to_svg(mol, file_obj, **kwargs)


#============================================
def pdf_mol_to_file(mol: object, file_obj: object, **kwargs: object) -> None:
	"""Render one molecule to PDF."""
	render_out.render_to_pdf(mol, file_obj, **kwargs)


#============================================
def png_mol_to_file(mol: object, file_obj: object, **kwargs: object) -> None:
	"""Render one molecule to PNG."""
	render_out.render_to_png(mol, file_obj, **kwargs)


#============================================
def ps_mol_to_file(mol: object, file_obj: object, **kwargs: object) -> None:

...
| `logger.py` | Application logger abstraction for normal, batch, and status modes. | `packages/bkchem-app/addons/fragment_search.py`; `packages/bkchem-app/bkchem/main.py` | ACTIVE |
...
| `validator.py` | Provide validator class that checks chemistry. | `packages/bkchem-app/bkchem/interactors.py`; `packages/bkchem-app/bkchem/paper.py` | ACTIVE |
